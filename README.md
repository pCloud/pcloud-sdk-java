...
[![Maven Central](https://img.shields.io/maven-central/v/com.pcloud.sdk/java-core/1.6.0?label=Maven%20Central)](https://search.maven.org/search?q=g:%22com.pcloud.sdk%22)
...
or Gradle:
```groovy
implementation 'com.pcloud.sdk:java-core:1.6.0'
```
 [![Maven Central](https://img.shields.io/maven-central/v/com.pcloud.sdk/java-core/1.6.0?label=Maven%20Central)](https://search.maven.org/artifact/com.pcloud.sdk/java-core/1.6.0/jar)
...
or Gradle:
```groovy
implementation 'com.pcloud.sdk:android:1.6.0'
```
[![Maven Central](https://img.shields.io/maven-central/v/com.pcloud.sdk/java-core/1.6.0?label=Maven%20Central)](https://search.maven.org/artifact/com.pcloud.sdk/android/1.6.0/jar)
